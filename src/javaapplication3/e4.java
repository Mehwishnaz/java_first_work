...
public void streaming() throws java.io.IOException{
                ...
                BufferedWriter bw = new BufferedWriter(new FileWriter("e4.txt", true));
    ...
    private void initComponents() {
        ...
        getContentPane().add(name, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 50, 110, -1));
        getContentPane().add(address, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 100, 110, -1));
        getContentPane().add(num, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 160, 110, -1));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/javaapplication3/motorola-moto-e4.jpg"))); // NOI18N
        jLabel4.setText("jLabel4");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 30, 160, -1));

        jLabel5.setText("PRICE 12,000 PKR");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            Logger.getLogger(e4.class.getName()).log(Level.SEVERE, null, ex);
        }
